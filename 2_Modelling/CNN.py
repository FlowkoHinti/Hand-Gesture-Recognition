...
eval_dir = project_dir / '5_Evaluation'
loss_curves_dir = project_dir / '5_Evaluation' / 'Loss_Curves'
...
def main(args):
    ...
    datasets = {
        "all": DetectionDataset(conf=conf, dataset_type="test", transform=Transforms.CropToBBox())
    }
